...
const Navbar = () => {
    const menuItems = <>
        ...
        <li><a href="#contact"><span className='text-secondary'><FontAwesomeIcon icon={faAddressBook} /></span> Contact Me</a></li>
    </>
    return (
        <div className="navbar bg-primary justify-between px-20 ">
